            ...
            <Formik
                ...
                {(formikProps: FormikHelpers<FormValues>) => (
                    <div className="w-[900px] h-[500px] flex flex-col m-auto  border border-btnColor">
                        <h2 className="text-secondary font-bold  pl-8 pt-8">Sign Up</h2>
                        <div className="grid sm:grid-cols-3 gap-4">
                            <div className="form-left col-span-2 pl-8 pr-8 pt-10">
                                <form className="flex flex-col relative">
                                    <label className="flex flex-col mb-3">
                                        <span className="text-bold mb-2">Full Name</span>
                                        <input
                                            type="text"
